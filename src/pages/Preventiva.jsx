...
const Preventiva = () => {
  const ordensIniciais = [
    { id: 1, cliente: "Shopping Morumbi", elevador: "ELEV-501", status: "Agendada", data: "2025-09-05" },
    { id: 2, cliente: "Hospital Albert Einstein", elevador: "ELEV-602", status: "Em andamento", data: "2025-09-06" },
    { id: 3, cliente: "Condomínio Verde", elevador: "ELEV-703", status: "Concluída", data: "2025-08-30" },
    { id: 4, cliente: "Universidade USP", elevador: "ELEV-804", status: "Agendada", data: "2025-09-10" },
  ];
    ...
    <div style={{ padding: 20 }}>
      <div style={{ display: "flex", alignItems: "center" }}>
        <h2 style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <FaShieldAlt style={{ color: "#041c44" }} /> Ordens Preventivas
        </h2>
      </div>
      <p style={{ color: "#6b7280" }}>
        Aqui você pode consultar todas as ordens preventivas de elevadores.
      </p>
      ...
      <div className="d-flex gap-3 mb-3">
        ...
        <button
          style={{ background: "#2ecc71", color: "white", padding: "8px 16px", borderRadius: 6, border: "none", cursor: "pointer" }}
        >
          + Nova Ordem
        </button>
      </div>
